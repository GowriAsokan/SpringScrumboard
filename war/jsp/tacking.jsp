...
$('#table').append('<li class="list-group-item" data-taskId="'+result[i].id+'" id="'+result[i].id+'"> <span class="description" id="task'+i+'"><span><img src="edit.jpg" id="myBtn'+i+'" class="icon" title="Edit"/></span>' + result[i].goals + '</span></li>');
} else if(result[i].status == 'working'){
$('#table1').append('<li class="list-group-item" data-taskId="'+result[i].id+'" id="'+result[i].id+'"> <span class="description" id="task'+i+'"><span><img src="edit.jpg" id="myBtn'+i+'" class="icon" title="Edit"/></span>' + result[i].goals + '</span></li>');
} else if(result[i].status == 'verification'){
$('#table2').append('<li class="list-group-item" data-taskId="'+result[i].id+'" id="'+result[i].id+'"> <span class="description" id="task'+i+'"><span><img src="edit.jpg" id="myBtn'+i+'" class="icon" title="Edit"/></span>' + result[i].goals + '</span></li>');
} else if(result[i].status == 'verified'){
$('#table3').append('<li class="list-group-item" data-taskId="'+result[i].id+'" id="'+result[i].id+'"> <span class="description" id="task'+i+'"><span><img src="edit.jpg" id="myBtn'+i+'" class="icon" title="Edit"/></span>' + result[i].goals + '</span></li>');
}
}
...
<img src="asd.png" class="navbar-header">
<h3 id="project title" class="text-center">HTML &amp; CSS &amp; Bootstrap</h3>
</div>

<a class="boot2" href="Projectpage.html">back to project page</a>
